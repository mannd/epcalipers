...
- Choisir une image ou un PDF dans vos fichiers (iOS)
...
:END:
Vos préférences comme les couleurs des compas et les intervalles par défaut de l'étalonnage peuvent être choisies en choisissant le menu *Paramètres* ou *Préférences* selon la version de l'application. 
