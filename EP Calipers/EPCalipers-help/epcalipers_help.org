...
The triangle base will be located 5 mm below the apex of the triangle.  Proper alignment of this triangle with an r' wave in a person with a suspected Brugada ECG will provide measurement of the so-called 𝞫 angle and the triangle base.  ECGs with 𝞫 angle > 58° and/or triangle base > 160 msec (4 mm at standard ECG recording speed of 25 mm/sec) have an increased probability of having a Brugada ECG.  Please see [[http://europace.oxfordjournals.org/content/16/11/1639][this article]] for further information.
* Preferences
