...
** Angle calipers
Angle calipers are moved as a unit by dragging at the apex or just above the apex of the angle.  The apex is where the two lines joing together.  Dragging either bar of an angle caliper a little distance away from the apex will open or close the angle.
...
The triangle base will be located 5 mm below the apex of the triangle.  Proper alignment of this triangle with an r' wave in a person with a suspected Brugada ECG will provide measurement of the so-called /beta angle/ and the triangle base.  ECGs with triangle base > 160 msec (4 mm at standard ECG recording speed of 25 mm/sec) have an increased probability of having a Brugada ECG, and this may be a better criterion than the beta angle.   Please see [[http://europace.oxfordjournals.org/content/16/11/1639][this article]] for further information.
* Preferences
